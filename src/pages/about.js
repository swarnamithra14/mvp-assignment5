...
export default function About() {
  return (
    <>
      ...
      <main >
        <h1>About Mitti Mithra</h1>
        <p>
          <strong>Mitti Mithra</strong> is a community-driven initiative focused on promoting sustainable agricultural practices, soil health, and environmental awareness. 
        </p>
        <p>
